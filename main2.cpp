        ...
        for (int j=i; j<n; j++) {
            ...
            if (count <= k) {   //check if count is valid
                if (flag && count == k/2) {     //special case for k/2, k is even
                    ...
                    && (!k2Seen[count] || k2[count].second-k2[count].first > j-i)
                ...
                else if ((!k2Seen[count] || k2[count].second-k2[count].first > j-i)
                    && (!k2Seen[k-count] || !checkOverlap(make_pair(i,j), k2[k-count]))) {
                    k2[count].first = i;
                    k2[count].second = j;
                    k2Seen[count] = 1;
                }
